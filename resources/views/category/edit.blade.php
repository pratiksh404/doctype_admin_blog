      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <input type="text" name="name" class="form-control" placeholder="Enter Post Category" value="{{$category->name ? $category->name : old('name')}}">
            <br>
            <input type="text" name="slug" class="form-control" placeholder="Enter Post Category Slug" value="{{$category->slug ? $category->slug : old('slug')}}">
            <br>
