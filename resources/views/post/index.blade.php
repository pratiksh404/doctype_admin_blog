            ...
            <div class="card-body">
              <table id="datatable" class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                    ...
                    <a href="{{url(config('blog.prefix','admin').'/'.'post').'/'.$post->id}}" class="btn btn-sm btn-primary" target="_blank" title="Show Post"><i class="fas fa-eye"></i></a>
                    <a href="{{url(config('blog.prefix','admin').'/'.'post').'/'.$post->id.'/edit'}}" target="_blank" class="btn btn-sm btn-warning" title="Edit Post"><i class="fas fa-edit"></i></a>
