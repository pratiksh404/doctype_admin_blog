...
{
    protected $signature = "DoctypeAdminBlog:install {--c|config : Installs only config file} {--f|view : Installs only view files} {--m|migration : Installs only migration files} {--s|seed : Installs only seed files} {--a|all : Installs all publishable files}";
